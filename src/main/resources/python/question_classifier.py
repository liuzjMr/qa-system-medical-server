...
#
        ...
        self.disease_path = "src/main/resources/dict/disease.txt"
        self.department_path = "src/main/resources/dict/department.txt"
        self.check_path = "src/main/resources/dict/check.txt"
        self.drug_path = "src/main/resources/dict/drug.txt"
        self.food_path = "src/main/resources/dict/food.txt"
        self.producer_path = "src/main/resources/dict/producer.txt"
        self.symptom_path = "src/main/resources/dict/symptom.txt"
        self.deny_path = "src/main/resources/dict/deny.txt"
